...
void main() {
    ...
    // Inicializar el mensaje fijo en la línea 1
    lcd_gotoxy(1, 1);
    ...
    do {
        ...
        // Actualizar solo la línea 2 según el valor de A
        lcd_gotoxy(1, 2); // Ir a la segunda línea
        switch (A) {
            case 0:
                printf(lcd_putc, "                "); // Borrar la línea
                break;
            case 1:
